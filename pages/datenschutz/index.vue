  ...
  <div id="datenschutz">
    <div class="row">
      <div class="datenschutz">
        ...
        />
        <p>
          Der Schutz Ihrer persönlichen Daten ist uns wichtig. Daher möchten wir
          Sie an dieser Stelle informieren, wie wir die Datenschutzbestimmungen
          im Rahmen unseres Internet-Angebotes umsetzen.
        </p>
        <h3>
        ...
        <p>
          ...
          Deutschland <br />
          <br />
          E-Mail: datenschutz@mooxl.de <br />
        </p>
        <h3>
        ...
        <p>
          ...
          ausschließlich um anonymisierte Informationen, welche keine
        ...
        <p>
          ...
          f der Datenschutz-Grundverordnung (EU-Verordnung 2016/679)
          (nachfolgend „DSGVO“). Unser berechtigtes Interesse folgt aus oben
          ...
          ziehen. Empfänger der Daten sind nur die angegebene verantwortliche
          Stelle und ggf. Auftragsverarbeiter.
        </p>
        <h3>3. Cookies</h3>
        <p>
          Im Gegensatz zu anderen Seiten, verwenden wir überhaupt keine Cookies.
          Deswegen sehen Sie auch keinen Cookie-Consent-Banner auf unserer
          Website.
          <br />
          <br />
          Cookies sind kleine Textdateien, die von einem Websiteserver auf Ihr
          Endgerät (Laptop, Tablet, Smartphone o.ä.) übertragen und dort
          ...
          Viren oder sonstige Schadsoftware auf Ihr Endgerät zu übertragen.
          ...
          ermöglichen. Der Einsatz von Cookies dient einerseits dazu, die
          Nutzung des Angebots für Sie angenehmer zu gestalten. So können
          sogenannte Session-Cookies eingesetzt werden, um zu erkennen, dass Sie
          einzelne Seiten einer Website bereits besucht haben. Diese werden nach
          Verlassen unserer Seite normalerweise automatisch gelöscht. Darüber
          hinaus können ebenfalls zur Optimierung der Benutzerfreundlichkeit
          temporäre Cookies benutzt werden, die für einen bestimmten
          festgelegten Zeitraum auf Ihrem Endgerät gespeichert werden. Besuchen
          Sie dieseSeite erneut, um unsere Dienste in Anspruch zu nehmen, wird
          automatisch erkannt, dass Sie bereits auf der Website waren und welche
          ...
          verwenden Sie die Hilfefunktionen Ihres Internetbrowsers, um zu
        ...
        <h3>4. Analyse- und Tracking-Tools</h3>
        <p>
          Die im Folgenden aufgeführte und von uns eingesetzte Analyse- und
          Tracking-Maßnahme (nachfolgend „Maßnahme“) wird auf Grundlage des Art.
          6 Abs. 1 S. 1 lit. f DSGVO durchgeführt. Mit der zum Einsatz kommenden
          Maßnahme wollen wir eine bedarfsgerechte Gestaltung und die
          fortlaufende Optimierung unserer Webseite sicherstellen. Zum anderen
          setzen wir die Maßnahme ein, um die Nutzung unserer Webseite
          statistisch zu erfassen und zum Zwecke der Optimierung unseres
          Webangebotes für Sie auszuwerten. Diese Interessen sind als berechtigt
          ...
          weswegen eine Weiterleitung der Daten an Dritte nicht erfolgt. Weitere
          Informationen finden Sie in der Dokumentation für Umami Analytics
          unter:{' '}
        ...
        <p>
          ...
          der anschließenden Beantwortung derselben. Die von Ihnen gemachten
        ...
        <h3>
          6. Zwecke der Datenverarbeitung, Weitergabe von Daten
        </h3>
        <p>
        ...
        <h3>7. Löschung und Sperrung von Daten</h3>
        <p>
          ...
          erforderlich ist oder wie es die von Gesetz- oder Verordnungsgebern
          vorgesehenen Speicherfristen vorsehen. Nach Fortfall des jeweiligen
          Zweckes bzw. Ablauf dieser Fristen werden die entsprechenden Daten
          routinemäßig und gemäß den rechtlichen Vorgaben gesperrt oder
          gelöscht.
        </p>
        ...
        <ul className="my-1 list-disc list-inside">
          <li>
            gemäß Art. 15 DSGVO Auskunft über Ihre bei uns gespeicherten Daten
            und deren Verarbeitung;
          </li>
          <li>
            gemäß Art. 16 DSGVO Berichtigung unrichtiger personenbezogener
            Daten;
          </li>
          <li>
            gemäß Art. 17 DSGVO Löschung Ihrer bei uns gespeicherten Daten,
          ...
          <li>
            gemäß Art. 18 DSGVO Einschränkung der Datenverarbeitung, sofern wir
            Ihre Daten aufgrund gesetzlicher Pflichten noch nicht löschen
            dürfen;
          </li>
          <li>
          ...
          <li>
            gemäß Art. 21 DSGVO Widerspruch gegen die Verarbeitung Ihrer Daten
            bei uns, soweit dafür Gründe vorliegen, die sich aus Ihrer
        ...
        <p>
          ...
          machen, kontaktieren Sie uns bitte per E-Mail unter unserer in Ziffer
          1. angegebenen E-Mail-Adresse.
          <br />
        ...
        <h3>
          10. Aktualität und Änderung dieser Datenschutzerklärung, Fragen
        </h3>
        <p>
          ...
          <br />
          <br />
          Bitte zögern Sie nicht, bei ergänzenden Fragen zum Thema Datenschutz
          mit uns Kontakt aufzunehmen. Unsere Kontaktdaten ersehen Sie bitte aus
          Ziff. 1 dieser Datenschutzerklärung.
          <br />
          <br />
          Stand: 16.03.2022
        </p>
